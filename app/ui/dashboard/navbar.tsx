...
const Navbar = () => {
  ...
  return (
    <div className="shadow-sm bg-bgSoft ">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between flex-row-reverse md:flex-row items-center py-3 md:space-x-10 transition-all duration-500 ease-in-out">
          ...
          <div className="flex justify-start lg:w-0 lg:flex-1">
            <a href="/" className="text-base font-medium text-white hover:text-white transition-colors duration-300 ease-in-out">
              Dashboard
            </a>
          </div>
          ...
          <div
            className={`absolute top-0 inset-x-0 p-2 transition-transform duration-500 ease-in-out ${isMobileMenuOpen ? "translate-y-0" : "-translate-y-full"} md:hidden`}
          >
            ...
            <div className="rounded-lg shadow-md bg-bgSoft ring-1 ring-black ring-opacity-5 overflow-hidden">
              ...
              <div className="px-2 pt-2 pb-3 space-y-1">
                <a href="#" className="block px-3 py-2 rounded-md text-base font-medium text-white hover:bg-gray-50 transition-colors duration-300 ease-in-out">
